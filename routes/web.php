...
Route::get('pelanggan', 'pelangganController@data')->name('home');
Route::get('pelanggan/tambah', 'pelangganController@tambah')->name('home');
Route::post('pelanggan', 'pelangganController@tambahProcess')->name('home');
Route::get('pelanggan/ubah/{id}', 'pelangganController@ubah')->name('home');
Route::post('pelanggan/ubah/{id}', 'pelangganController@update')->name('home');
Route::delete('pelanggan/{id}', 'pelangganController@delete')->name('home');
