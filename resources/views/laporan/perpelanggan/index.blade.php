...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Perpelanggan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                        <li class="breadcrumb-item active">Perpelanggan</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-body pt-4">
                <form action="{{ route('laporan.perpelanggan.index') }}" method="GET">
                    <div class="row">
                        <div class="col-md-2">
        ...
        <div class="card">
            <div class="card-body pt-4">
                @foreach ($pelanggan as $key => $pesanan)
                    ...
                    <br>
                @endforeach
                <form action="{{ route('laporan.perpelanggan.print') }}" method="GET" target="_blank">
